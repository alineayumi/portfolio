...
export default function Nav() {
  ...
  const selectedNavLinkStyle =
    "block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent text-black md:p-0 hover:underline";
  ...
  return (
    <nav className="flex flex-row justify-between sticky top-0 items-center px-3 sm:px-4 py-2.5 rounded bg-green h-[60px] mx-[20px] mt-[20px]">
